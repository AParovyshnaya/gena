...
Гена будет получать файл по абсолютному пути. Абсолютный путь пока что будем давать как строку, потом сделаем виджет.
...
Сайт будет собой представлять папку с index.html, другими страницами, от страниц категорий и товаров до служебных страниц, изображениями, файлами стилей. Сейчас же мы попробуем вывести на страницу информацию о нашем товаре.
