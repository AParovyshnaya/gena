...
Сайт будет собой представлять папку с index.html, другими страницами, от страниц категорий и товаров, до служеюных, изображениями, файлами.css. Сейчас же мы попробуем вывести на страницу информацию о нашем товаре.

Мы будем генерировать из данных страницу HTML и прикреплять к ней описательные картинки с помощью Python-а. Нужно найти библиотеку, работающую с HTML.    